...
/* variable "loganalytics_workspace_name" {
  type        = string
  description = "Specifies the name of the Log Analytics Workspace in which the Linux Virtual Machine should exist"
}
...
/* variable "enable_log_analytics_extension" {
  type        = bool
  description = "Enable log analytics extention"
  default     = true
}
...
variable "enable_vm_insight" {
  type        = bool
  description = "enable VM insight"
  default     = true
} */
